...
기록은 단순 점수가 아니라 누적 수확 길이 `cm`로 표시됩니다. 목숨은 전체 5개, 밭은 전체 3개입니다. 한 밭에는 마늘쫑 4줄기가 있고, 현재 뽑을 줄기가 가운데로 옵니다.

플레이 중에는 `60초 챌린지` 숙련도 레벨이 함께 오릅니다. 최대 레벨은 `Lv.10`이며, 밭 3개/마늘쫑 12줄기 완주까지 보통 50초대에 들어오도록 한 줄기 진행 속도와 성공 후 템포를 맞췄습니다.
