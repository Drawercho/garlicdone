...
기록은 단순 점수가 아니라 누적 수확 길이 `cm`로 표시됩니다. 목숨은 전체 5개, 밭은 전체 5개입니다. 한 밭에는 마늘쫑 4줄기가 있고, 현재 뽑을 줄기가 가운데로 옵니다.

플레이 중에는 `60초 챌린지` 숙련도 레벨이 함께 오릅니다. 최대 레벨은 `Lv.10`이며, 보통 45~55초 안에 “마늘쫑 장인” 만렙 달성을 경험하도록 성공, 완벽 뽑기, 콤보, 재도전 진행도에 따라 숙련도 XP가 지급됩니다.
